//SHOW COURSES AVAILABLE IN THE PHONE NAV MENU
...
function whyInvest(x){
	...
	var why_invest = document.getElementById(`why-invest${x}`);
  	...
  	if(x == 1){
  		why_invest.style.backgroundImage = "url('images/i-01.png')";
  	}
  	else if(x == 2){
  		why_invest.style.backgroundImage = "url('images/i-02.png')";
  	}
  	else if(x == 3){
  		why_invest.style.backgroundImage = "url('images/i-03.png')";
  	}
  	else if(x == 4){
  		why_invest.style.backgroundImage = "url('images/i-04.png')";
  	}
}
...
function whyInvestC(x){
	...
	if (state == 1) {
  	...
  	if(x == 1){
  		why_invest.style.backgroundImage = "url('images/i-01.jpg')";
  	}
  	else if(x == 2){
  		why_invest.style.backgroundImage = "url('images/i-02.jpg')";
  	}
  	else if(x == 3){
  		why_invest.style.backgroundImage = "url('images/i-03.jpg')";
  	}
  	else if(x == 4){
  		why_invest.style.backgroundImage = "url('images/i-04.jpg')";
  	}
